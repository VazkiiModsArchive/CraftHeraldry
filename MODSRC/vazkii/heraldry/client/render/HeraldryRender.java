...
public final class HeraldryRender {
	...
	public static void renderCrest(CrestData crest, double x, double y, double z, boolean bg) {
		...
		if(bg) {
			...
			drawTexturedQuad(x, y, z - 0.01, 64, 64, ssx * scalex, (ssx + 1) * scalex, ssy * scaley, (ssy + 1) * scaley);
		}
		...
		drawTexturedQuad(x, y, z + 2, 64, 64, ssx * scalex, (ssx + 1) * scalex, ssy * scaley, (ssy + 1) * scaley);
		GL11.glPopMatrix();
	}
